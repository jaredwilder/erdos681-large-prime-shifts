...
theorem erdos681_n999997304512_no_witness :
    ¬ ∃ k, 0 < k ∧ ¬ Nat.Prime (999997304512 + k) ∧ 1 < 999997304512 + k ∧ k ^ 2 < Nat.minFac (999997304512 + k) := by
...
#print axioms erdos681_n999997304512_no_witness
